...
async def gen_thumb(videoid):
    ...
    try:
        ...
        return f"https://graph.org/file/e66caa3ae1f673b2e7c9e.jpg"
...
async def play(client, message: Message):
    ...
    keyboard = InlineKeyboardMarkup(inline_keyboard=[
        ...
        [InlineKeyboardButton("𝐶ℎ𝑎𝑛𝑛𝑒𝑙", url=f"https://t.me/Source_Theo")],
        [InlineKeyboardButton("𝐺𝑟𝑜𝑢𝑝", url=f"https://t.me/PP_5U")],
        [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ✅", url=f"https://t.me/{BOT_USERNAME}?startgroup=dream")],
    ])
    type = "audio"
...
🎧 **بواسطه:** {ruser}
        ...
        try:
            ...
            if 'CreateGroupCall' in str(e):
                ...
                return await dream.edit_text(f"{e}\n◍ في حاله ظهور لك مثل هذه المشكله تواصل مع المطور -> @XIX_A")
        ...
        if data == "resume":
            ...
            if not get:
                ...
                keyboard = InlineKeyboardMarkup(inline_keyboard=[
                    ...
                    [InlineKeyboardButton("𝐶ℎ𝑎𝑛𝑛𝑒𝑙", url=f"https://t.me/Source_Theo")],
                    [InlineKeyboardButton("𝐺𝑟𝑜𝑢𝑝", url=f"https://t.me/PP_5U")],
                    [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ✅", url=f"https://t.me/{c.me.username}?startgroup=dream")],
                ])
    ...
    if admin(msg):
        ...
        if command == "/pause":
            ...
            keyboard = InlineKeyboardMarkup(inline_keyboard=[
                ...
                [InlineKeyboardButton("𝐶ℎ𝑎𝑛𝑛𝑒𝑙", url="https://t.me/Source_Theo")],
                [InlineKeyboardButton("𝐺𝑟𝑜𝑢𝑝", url=f"https://t.me/PP_5U")],
                [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ✅", url=f"https://t.me/{bot_user}?startgroup=dream")],
            ])
    ...
    try:
        ...
        if not videoid:
            ...
            keyboard = InlineKeyboardMarkup(inline_keyboard=[
                ...
                [InlineKeyboardButton("𝐶ℎ𝑎𝑛𝑛𝑒𝑙", url=f"https://t.me/Source_Theo")],
                [InlineKeyboardButton("𝐺𝑟𝑜𝑢𝑝", url=f"https://t.me/PP_5U")],
                [InlineKeyboardButton("ضيـف البـوت لمجمـوعتـك ✅", url=f"https://t.me/{app.me.username}?startgroup=dream")],
            ])
